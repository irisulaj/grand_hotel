      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          <div className="grid grid-cols-2 gap-4">
            <img
              src="./src/assets/images/lounge/IMG_0126.jpeg"
              alt="Hotel Lobby"
              className="w-full h-64 object-cover self-start"
            />
            <img
              src="./src/assets/images/lounge/IMG_0129.jpeg"
              alt="Hotel Lounge"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <img
            src="./src/assets/images/lounge/IMG_0788.jpeg"
            alt="Restaurant"
            className="w-full h-72 object-cover"
          />
          <img
            src="./src/assets/images/lounge/IMG_0787.jpeg"
            alt="Food Service"
            className="w-full h-72 object-cover"
          />
          <img
            src="./src/assets/images/lounge/IMG_0769.jpeg"
            alt="Conference Room"
            className="w-full h-72 object-cover"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <img
            src="./src/assets/images/lounge/IMG_0771.jpeg"
            alt="Restaurant"
            className="w-full h-72 object-cover"
          />
          <img
            src="./src/assets/images/lounge/IMG_0782.jpeg"
            alt="Food Service"
            className="w-full h-72 object-cover"
          />
          <img
            src="./src/assets/images/lounge/IMG_0784.jpeg"
            alt="Conference Room"
            className="w-full h-72 object-cover"
          />
        </div>
